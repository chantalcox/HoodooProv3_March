...
(function($) {
    ...
    $("#product-assessment-form").submit(function(e) {
        e.preventDefault();
        ...
        if (!isValidEmail(email) || (name.length < 1)) {
            ...
            $.ajax({
                url: "https://docs.google.com/a/hoodoopro.com/forms/d/1tFhrYEVoOOvS_pDnnXGJaPGdAJGc2n7bNWdK4qnfb3k/formResponse",
                data: {"entry.1471163054" : name, "entry.1028580452" : email},
                type: "POST",
                dataType: "xml",
            });
            ...
            window.open("https://annyhsu.typeform.com/to/Y6NZ8a", '_blank');
